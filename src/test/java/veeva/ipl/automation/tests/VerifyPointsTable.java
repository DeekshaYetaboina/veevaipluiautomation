package veeva.ipl.automation.tests;

import veeva.ipl.automation.pageobjects.PointsTablePage;
import veeva.ipl.automation.utils.TestDataUtils;
...
public class VerifyPointsTable extends BaseTest {
    private static final Logger log = LogManager.getLogger(VerifyPointsTable.class);
    ...
    public void verifyPointsTable() throws IOException {
        ...
        log.info("Actual Points: {}, Expected Points: {}", actualPoints, expectedPoints);
