package veeva.ipl.automation.abstractcomponents;
...
/**
 * AbstractComponents class provides reusable methods for common UI interactions across different pages in the automation framework.
